        ...
        <div class="prose prose-invert max-w-none space-y-8">
          <section class="bg-background-light rounded-lg p-6">
            ...
            <p class="text-text-secondary leading-relaxed">
              Welcome to Raadnerd. By accessing or using this website, you agree to be bound by
          ...
          <section class="bg-background-light rounded-lg p-6">
            ...
            <div class="text-text-secondary space-y-4">
              <p class="leading-relaxed">
                Permission is granted to temporarily view and browse the materials on this website for personal,
          ...
          <section class="bg-background-light rounded-lg p-6">
            ...
            <div class="text-text-secondary space-y-3">
              <p class="leading-relaxed">
                ...
                intellectual property rights are reserved. You may access this from the website for your own personal
                use subject to restrictions set in these terms and conditions.
              </p>
              <p class="leading-relaxed">
                My projects and code repositories may have their own specific licenses. Please refer to individual
                project repositories for their respective licensing terms.
              </p>
            </div>
          </section>
          ...
          <section class="bg-background-light rounded-lg p-6">
            ...
            <div class="text-text-secondary space-y-3">
              <p class="leading-relaxed">
                If you submit any content to this website (such as comments, messages, or feedback), you grant me a
                non-exclusive, worldwide, royalty-free license to use, reproduce, modify, and display that content.
              </p>
              <p class="leading-relaxed">
                You are responsible for ensuring that any content you submit does not violate any third-party rights or
                applicable laws. You must not post:
              </p>
              <ul class="ml-6 list-disc space-y-2">
          ...
          <section class="bg-background-light rounded-lg p-6">
            ...
            <div class="text-text-secondary space-y-3">
              ...
              <p class="leading-relaxed">
                ...
                reliability of the use of the materials on the website or otherwise relating to such materials or on any
          ...
          <section class="bg-background-light rounded-lg p-6">
            ...
            <p class="text-text-secondary leading-relaxed">
              ...
              materials on this website, even if I or my authorized representative has been notified orally or in
          ...
          <section class="bg-background-light rounded-lg p-6">
            ...
            <p class="text-text-secondary leading-relaxed">
              The materials appearing on this website could include technical, typographical, or photographic errors. I
              do not warrant that any of the materials on the website are accurate, complete, or current. I may make
              changes to the materials contained on the website at any time without notice. However, I do not make any
          ...
          <section class="bg-background-light rounded-lg p-6">
            ...
            <div class="text-text-secondary space-y-3">
              <p class="leading-relaxed">
                ...
                me. I have no control over, and assume no responsibility for, the content, privacy policies, or
                practices of any third-party websites or services.
              </p>
              <p class="leading-relaxed">
                You acknowledge and agree that I shall not be responsible or liable, directly or indirectly, for any
          ...
          <section class="bg-background-light rounded-lg p-6">
            ...
            <p class="text-text-secondary leading-relaxed">
              I may revise these terms of service for the website at any time without notice. By using this website, you
              are agreeing to be bound by the then current version of these terms of service. Changes will be effective
          ...
          <section class="bg-background-light rounded-lg p-6">
            ...
            <p class="text-text-secondary leading-relaxed">
              I reserve the right to terminate or suspend your access to the website immediately, without prior notice
