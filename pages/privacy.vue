      ...
      <div class="mx-auto max-w-4xl">
        ...
        <div class="prose prose-invert max-w-none space-y-8">
            ...
            <div class="text-text-secondary space-y-4">
              <div>
                ...
                <p class="leading-relaxed">
                  When you subscribe to my newsletter or contact me, I may collect:
                </p>
          ...
          <section class="bg-background-light rounded-lg p-6">
            ...
            <div class="text-text-secondary space-y-3">
              ...
              <ul class="ml-6 list-disc space-y-2">
                ...
                <li>With service providers who help operate the website (e.g., hosting providers)</li>
              </ul>
            </div>
          </section>
          ...
          <section class="bg-background-light rounded-lg p-6">
            ...
            <div class="text-text-secondary space-y-3">
              <p class="leading-relaxed">
                This website uses cookies and similar tracking technologies to enhance your browsing experience. Cookies
                are small text files stored on your device that help me:
              </p>
              <ul class="ml-6 list-disc space-y-2">
          ...
          <section class="bg-background-light rounded-lg p-6">
            ...
            <p class="text-text-secondary leading-relaxed">
              This website may contain links to third-party websites. I am not responsible for the privacy practices or
          ...
          <section class="bg-background-light rounded-lg p-6">
            ...
            <p class="text-text-secondary leading-relaxed">
              ...
              information from children. If you believe I have collected information from a child, please contact me
              immediately.
            </p>
          </section>
          ...
          <section class="bg-background-light rounded-lg p-6">
            ...
            <p class="text-text-secondary leading-relaxed">
              ...
              updated "Last updated" date. I encourage you to review this policy periodically.
            </p>
          </section>
