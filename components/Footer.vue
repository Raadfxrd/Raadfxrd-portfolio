      ...
      <div class="mb-10 md:mb-16 grid grid-cols-1 gap-8 md:gap-12 sm:grid-cols-2 lg:grid-cols-4">
        <div class="space-y-4 md:space-y-6 md:pr-8">
          ...
          <div class="flex items-center space-x-4 md:space-x-6">
            ...
            >
              <i
                  class="devicon-github-original text-text-secondary group-hover:text-text-primary text-xl md:text-2xl transition-colors duration-200 align-middle"
              ></i>
            </a>
            <a
                class="group block transform transition-all duration-200 ease-out hover:scale-110"
            ...
            >
              <i
                  class="devicon-linkedin-plain text-text-secondary group-hover:text-text-primary text-xl md:text-2xl transition-colors duration-200 align-middle"
              ></i>
            </a>
            <a
                class="group block transform transition-all duration-200 ease-out hover:scale-110"
            ...
            >
              <svg
                  class="text-text-secondary group-hover:text-text-primary w-[1.25rem] h-[1.25rem] md:w-[1.5rem] md:h-[1.5rem] transition-colors duration-200 align-middle"
                  fill="currentColor"
                  viewBox="0 0 24 24"
